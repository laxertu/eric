...
class RepositoryError(Exception):
    ...
    Concrete implementations of :class:`eric_sse.persistence.ObjectRepositoryInterface` should wrap here the unexpected exceptions they catch before raising, and
